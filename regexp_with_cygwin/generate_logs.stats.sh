...
#**************************************************************************h *#
function gen_stat() {
 cd ./sh && ./${1}.sh $2 "$3" $4 > ../log/${1}.${2}.stats.sh.log 2>&1 && cd ..
